...
var TreeNode = function (_React$Component) {
  ...
  TreeNode.prototype.renderSwitcher = function renderSwitcher(props, expandedState) {
    ...
    var switcherCls = classNames(prefixCls + '-switcher', prefixCls + '-switcher_' + expandedState, (_classNames = {}, _classNames[prefixCls + '-switcher-disabled'] = props.disabled, _classNames));
  ...
  TreeNode.prototype.renderChildren = function renderChildren(props) {
    ...
    if (children && (Array.isArray(children) && children.length && children.every(function (item) {
      ...
      var cls = classNames(props.prefixCls + '-child-tree', (_classNames2 = {}, _classNames2[props.prefixCls + '-child-tree-open'] = props.expanded, _classNames2));
